...
\**
![表格 AI
生成的内容可能不正确。](assets/media/image13.png){width="5.768055555555556in"
height="3.225in"}**\**
并记得在完成后**点击接受更改并提交**
...
当你不想每次都进行检查时，请使用\
![图形用户界面, 应用程序 AI
生成的内容可能不正确。](assets/media/image15.png){width="5.768055555555556in"
...
![图形用户界面, 文本, 应用程序, 电子邮件 AI
生成的内容可能不正确。](assets/media/image16.png){width="5.423082895888014in"
height="2.9093733595800524in"}

选择起始和结束章节

![图形用户界面, 应用程序 AI
生成的内容可能不正确。](assets/media/image17.png){width="5.09163167104112in"
height="2.734621609798775in"}**\**
输出文本，**位置默认为backend/你工作区的名字_project** 下\
![](assets/media/image18.png){width="5.033807961504812in"
